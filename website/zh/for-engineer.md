---
title: 给工程师 — mq9 集成指南
description: 如何将 mq9 集成到你的系统中。快速开始、Agent 注册发现、SDK 示例、部署和常见模式。
---
...
> 本页专注于集成代码和生产注意事项。设计原理见[什么是 mq9](/zh/what)，协议视角见[给 Agent](/zh/for-agent)。
...
| 场景 | 关键特性 |
|------|----------|
| 动态发现路由 | AGENT.REGISTER + AGENT.DISCOVER + SEND |
| 点对点通信 | 私有邮箱 + FETCH + ACK |
| 竞争消费 | 多 Worker 共享 `group_name` |
| 广播 | 命名公共邮箱，多消费者各自 `group_name` |
