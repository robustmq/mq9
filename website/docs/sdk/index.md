...
The full subject reference is in [Protocol](../protocol). All examples below connect to `nats://localhost:4222`.
...
Full protocol specification: [Protocol Design](../protocol).
